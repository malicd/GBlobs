...
class NuScenesDataset(DatasetTemplate):
    ...
    def __getitem__(self, index):
        if self.tta and not self.training:
            return [self._getitem(index) for _ in range(self.dataset_cfg.TTA_NUM_AUGS)]
...
def create_nuscenes_info(version, data_path, save_path, max_sweeps=10, with_cam=False):
    ...
    if version == 'v1.0-test':
        ...
        with open(save_path / f'nuscenes_infos_{max_sweeps}sweeps_trainval.pkl', 'wb') as f:
            pickle.dump(train_nusc_infos, f)
...
if __name__ == '__main__':
    ...
    if args.func == 'create_nuscenes_infos':
        ...
        create_nuscenes_info(
            ...
            data_path=ROOT_DIR / 'data' / 'robosense',
            save_path=ROOT_DIR / 'data' / 'robosense',
        ...
        nuscenes_dataset = NuScenesDataset(
            ...
            root_path=ROOT_DIR / 'data' / 'robosense',
